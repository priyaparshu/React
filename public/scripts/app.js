...
var Indecision = function (_React$Component) {
  ...
  _createClass(Indecision, [{
    ...
    value: function handlePick() {
      ...
      var choice = this.state.options[randnum];
      alert(choice);
    }
  }, {
  ...
  _createClass(Options, [{
    ...
    value: function render() {
      return React.createElement(
        'div',
        null,
        this.props.options.map(function (m) {
          return React.createElement(Option, { key: m, holder: m });
        }),
...
var AddOption = function (_React$Component6) {
  ...
  _createClass(AddOption, [{
    ...
    value: function handleAdd(e) {
      e.preventDefault();
      var text = e.target.elements.input.value.trim();
      var error = this.props.handleAdd(text);
